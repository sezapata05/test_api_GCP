...
class TestModel():
    ...
    def test_model_preprocess_for_training(self):
        ...
        print(features)
        print(len(self.FEATURES_COLS))
        print(set(self.FEATURES_COLS))
        
        print(target)
        print(len(self.TARGET_COL))
        print(set(self.TARGET_COL))
...
if __name__ == "__main__":
    objTestModel = TestModel()
    objTestModel.test_model_preprocess_for_training()